...
export function isAllowedMember(member: Character | undefined) {
...
export function getPlayerVolume(modifier: number) {
...
export function IsIncapacitated(C?: OtherCharacter | PlayerCharacter): boolean {
	...
	if (C.LSCG && !!C.LSCG.StateModule) {
		...
		paralyzed = C.LSCG?.StateModule.states.find(s => s.type == "frozen")?.active ?? false;
	}
...
export function htmlToElement(html: string): HTMLElement | ChildNode | null {
...
export const ICONS = Object.freeze({
	...
	SHRINK: "data:image/png;base64,",
	EXPAND: "data:image/png;base64,",
	UP: "data:image/png;base64,",
	DOWN: "data:image/png;base64,",	
